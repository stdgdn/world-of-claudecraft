...
export const ACHIEVEMENT_MAP: Record<string, string> = {
  ...
  // completion / Illumination deeds join the mirror, the same id vocabulary
  // as the Steam twin. Registration of these ids in the Epic Developer
  // Portal is a maintainer release task.
